...
import { useViewportVideoWithSound } from "../components/Hookvideo.jsx";
...
const cardVariants = {
  ...
  visible: {
    ...
    transition: {
      duration: 0.8,
      ease: [0.22, 1, 0.36, 1], // ✨ premium cubic-bezier (easeOutExpo feel)
    },
  },
};
          ...
          <div className={styles.cards}>
            ...
            <motion.div variants={cardVariants} className={styles.card}>
              ...
              >
                {" "}
                <svg width="34" height="34" viewBox="0 0 24 24" fill="#EF4444">
                  <path d="M12 2C7.59 2 4 5.58 4 9.98c0 5.25 7 11.52 7.3 11.78a1 1 0 0 0 1.4 0C13 21.5 20 15.23 20 9.98 20 5.58 16.41 2 12 2zm0 11a3 3 0 1 1 0-6 3 3 0 0 1 0 6z" />
                </svg>
              </motion.span>
            ...
            <motion.div variants={cardVariants} className={styles.card}>
              ...
              >
                {" "}
                <svg width="34" height="34" viewBox="0 0 24 24" fill="#EF4444">
                  <path d="M12 2a10 10 0 1 0 .001 20.001A10 10 0 0 0 12 2zm1 11h4a1 1 0 1 1 0 2h-5a1 1 0 0 1-1-1V7a1 1 0 1 1 2 0v6z" />
                </svg>
              </motion.span>
          ...
          <div className={styles.grid}>
            ...
            <div className={styles.card}>
              ...
              <p className={styles.note}>
                <strong>Note:</strong> A 10% additional charges will be
                applicable for corner booth’s, subject to availability and floor
                plan approval. Booth allocation shall be made on first come
                first serve basis upon receipt of full payment. All taxes and
                statutory charges including GST @ 18% will be charged extra &
            ...
            <div className={styles.card}>
              ...
              <p className={styles.note}>
                <strong>Note:</strong> Exhibitors selecting the bare shell
                option shall be responsible for their own booth design,
                fabrication and dismantling, in compliance with venue and safety
                regulations. Customised structures must receive prior approval
                before installation. All taxes including GST @ 18% will be
                charged extra and shall be borne by the exhibitor.
              </p>
            </div>
          </div>
        </section>
